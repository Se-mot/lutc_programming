...
серверные CGI-сценарии на языке Python; обслуживает файлы и сценарии
в текущем рабочем каталоге; сценарии на языке Python должны находиться
в каталоге webdir/cgi-bin или webdir/htbin;
"""
...
port = 8888  # по умолчанию http://localhost/, иначе используйте
# http://localhost:xxxx/
