"""
Пример 3.8
обеспечивает постраничный вывод в stdout сщдержимого строки, файла или потока;
...
def getreply():
    """
    читает клавишу, нажатую пользователем, даже
    если stdin перенаправлен в файл или канал
    """
